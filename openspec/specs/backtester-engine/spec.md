...
Core backtesting engine that replays a trading strategy over historical candles, simulating trade execution with slippage and commissions, and producing performance metrics and trade logs.
