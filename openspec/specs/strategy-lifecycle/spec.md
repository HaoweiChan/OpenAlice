...
Divergence-aware strategy lifecycle management. Listens for `strategy.divergence` events from the performance tracker, optionally auto-pauses underperforming strategies, and notifies the user. Configurable via `data/config/automation.json`.
