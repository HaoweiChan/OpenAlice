...
AI-callable tools for managing live trading strategies. Provides the full lifecycle from design through deployment, monitoring, performance review, and improvement. Registered via `ToolCenter` in `main.ts`.
