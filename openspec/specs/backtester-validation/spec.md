...
Walk-forward validation to detect overfitting — split historical data into train/test windows, optimize parameters on training data, and validate on unseen test data.
