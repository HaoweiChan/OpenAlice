...
The bridge SHALL expose `WS /stream` for real-time tick and bidask subscriptions. Clients send subscribe/unsubscribe messages; the bridge forwards Shioaji quote callbacks as JSON frames.
